  ...
  return (
    <div>
      <div className="flex items-center gap-2">
        <label htmlFor="report-status-filter" className="text-sm font-medium text-slate-700">
          Status
        </label>
        <select
                ...
                <tr key={r.id}>
                  <td className="max-w-[16rem] px-4 py-3 text-sm">
                    <a
                      ...
                      className="line-clamp-2 font-medium text-primary-700 hover:text-primary-800"
                    >
                      {r.questionStem || "(question)"}
                    </a>
                  </td>
                  <td className="px-4 py-3 text-sm text-slate-600">{r.reporterName}</td>
                  ...
                  <td className="whitespace-nowrap px-4 py-3 text-right">
                    <button
                      ...
                      className="text-sm font-medium text-primary-700 hover:text-primary-800 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      {busyId === r.id
                        ? "..."
                        : r.status === "open"
