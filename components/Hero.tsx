export default function Hero() {
  return (
    <section className="mx-auto grid max-w-6xl items-center gap-16 px-6 pb-24 pt-20 md:grid-cols-2 md:pt-28">
      <div>
        <p className="mb-4 inline-flex items-center rounded-full bg-primary-50 px-3 py-1 text-xs font-medium uppercase tracking-wide text-primary-700">
      ...
      <div className="relative mx-auto h-72 w-full max-w-sm md:h-80">
        <div className="absolute inset-x-6 top-8 h-full rounded-2xl border border-slate-200 bg-primary-50/60" />
        <div className="absolute inset-x-3 top-4 h-full rounded-2xl border border-slate-200 bg-white shadow-sm" />
        <div className="absolute inset-0 flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-6 shadow-md">
          <div>
